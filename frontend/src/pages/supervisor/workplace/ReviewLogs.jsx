...
const statusMeta = {
  ...
  draft: {
    label: "Draft",
    cls: "bg-slate-400/15 text-slate-300 border-slate-500/30",
  },
};
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Week {log.week_number} · {log.student_name}
                </p>
              </div>
            </div>
            <button
            ...
            <div className="rounded-xl bg-[#0b1523] border border-[#1e3a5f] p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs text-slate-400">
                <div>
                  ...
                  <p className="text-white mt-0.5">Week {log.week_number}</p>
                </div>
                <div>
                  <span className="text-slate-600">Date</span>
                  <p className="text-white mt-0.5">{log.date}</p>
                </div>
              </div>
            </div>
                  ...
                  <div key={c.criteria}>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs text-slate-500">
                        {criteriaScores[c.criteria]}/{c.max_score}
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <input
                    ...
                    <div className="h-1.5 rounded-full bg-[#1a3050] overflow-hidden mt-1">
                      <div
                        ...
                        style={{
                          width: `${(criteriaScores[c.criteria] / c.max_score) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
          ...
          <div className="px-6 py-4 border-t border-[#1a3050] bg-[#0b1523] flex-shrink-0 space-y-2">
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() =>
                  onSubmit(log, "rejected", comment, criteriaScores)
                }
                disabled={saving}
              ...
              <button
                onClick={() =>
                  onSubmit(log, "reviewed", comment, criteriaScores)
                }
                disabled={saving}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {(log.status === "submitted" ||
                          ...
                          >
                            ...
                            {log.status === "reviewed" ? "Update" : "Review"}
                          </button>
                        )}
                      </div>
                    </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-0.5">
                    Review, approve, or reject submitted log entries.
                  </p>
                </div>
              </div>
          ...
          {totalPending > 0 && (
            <div className="flex items-center gap-3 px-5 py-3.5 rounded-xl bg-amber-400/8 border border-amber-500/25 text-amber-300">
              ...
              <p className="text-sm font-medium">
                ...
                {totalPending !== 1 ? "s" : ""} awaiting review.
              </p>
            </div>
          )}
